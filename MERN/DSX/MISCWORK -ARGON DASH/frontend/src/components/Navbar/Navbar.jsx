              ...
              <li className="nav-item d-flex align-items-center">
                ...
                >
                  ...
                  {token ? (<>
                    ...
                    <span className="d-sm-inline d-none" onClick={handleLogout}><i className="fa fa-user me-sm-1"></i>Sign Out</span></>
                  ) : (
                    <>
                    <span className="d-sm-inline d-none"><i className="fa fa-user me-sm-1"></i>Sign In</span></>
                  )}
                </a>
              </li>
