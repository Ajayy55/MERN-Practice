             ...
             <form onSubmit={handleSubmit}>
               ...
               <div className="mb-3">
                 <input
                   ...
                   maxLength={40}
                 />
                 {errors.mobile&& touched.mobile ?(<span className='text-danger  text-sm'>{errors.mobile}</span>):null}
               ...
               <div className="mb-3">
                 <input
                   ...
                   aria-label="Password"
                   name='password1'
                   value={values.password1} onChange={handleChange} onBlur={handleBlur}
                   maxLength={40}
                 />
                {errors.password1&& touched.password1 ?(<span className='text-danger text-sm'>{errors.password1}</span>):null}
               </div>
