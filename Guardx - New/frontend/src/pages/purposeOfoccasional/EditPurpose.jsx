...
function EditPurpose() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const response = await axios.patch(`${PORT}editPurpose`, formData, {
          headers: {
  ...
  useEffect(() => {
    ...
    formik.setValues({name: data.purpose,
                            ...
                            <option label="Choose Purpose Type"></option>
                                {   
                                    occasionalEntries?.map((entry)=>{
                                       return <option key={entry._id} >{entry?.title}</option>
                                    })
                                } 
                            </select>
