...
import { registerHouse,addHouseByAdmin,getHouseListBySocietyId,handleApprovalStatus,removeHouse,editHouse,removeHouseVehicle} from '../controllers/house.controller.js';
...
router.patch('/removeHouseVehicle/',removeHouseVehicle);
